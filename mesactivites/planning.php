...
$titlepage = "Planning OBM";
require_once('menus.php');
echo $doctype;
require_once ('tests.php');

echo '<div id="content" style="margin-left:10px;padding:0;width:auto;">
<h2>Réalisé de <a href="?chmois='.($moisactuel-1).'&channee='.$anneeactuel.'">'.$flprecedent.'</a> <span>'.$moisactuelmot.' '.$anneeactuel.'</span> <a href="?chmois='.($moisactuel+1).'&channee='.$anneeactuel.'" >'.$flsuivant.'</a> Le '.date('d/m/Y à h:i:s').'</h2>
...
// onClick="window.location=\'realiseuser.php?chuti='.$userlogin.'&chmois='.$moisactuel.'&channee='.$anneeactuel.'\'" onMouseOver="this.style.backgroundColor=\'#B5E655\';" onMouseOut="this.style.backgroundColor=\'#CCC\';"
		...
		for( $i = 1; $i <= 31; $i ++){
			...
			');
			$realise->setFetchMode(PDO::FETCH_OBJ); // on dit qu'on veut que le résultat soit récupérable sous forme d'obje
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
