...
if (isset($_POST['accepter'])){
	...
	echo '<div><fieldset style="width:400px;height:200px;background-color:#EEE;position:relative;top:30px;margin:0 auto;"><legend>Confirmation</legend><h1>Votre événement à bien été supprimer:</h1></fieldset></div>';
}else{
	echo '<h1>ERREUR !!!!<br/>Veuillez cocher la case de validation de suppression de l\'événement</h1>';
}
?>
